...
class SalesAnalystMocks
  ...
  def self.sales_analyst_mock(eg)
    ...
    transactions_as_hashes = TransactionMocks.transactions_as_hashes(number_of_hashes: 1, invoice_id: 0, result: :success)
    transactions_as_hashes += TransactionMocks.transactions_as_hashes(number_of_hashes: 1, invoice_id: 9, result: :failure)
